...
FE804000 CONSTANT I2C_C \ I2C_CONTROL_REGISTER_ADDRESS
FE804004 CONSTANT I2C_S \ I2C_STATUS_REGISTER_ADDRESS
FE804008 CONSTANT I2C_DLEN \ I2C_DATA_LENGTH_REGISTER_ADDRESS
FE80400C CONSTANT I2C_A \ I2C_SLAVE_ADDRESS_REGISTER_ADDRESS
FE804010 CONSTANT I2C_FIFO \ I2C_DATA_FIFO_REGISTER_ADDRESS
FE804014 CONSTANT I2C_DIV \ I2C_CLOCK_DIVIDER_REGISTER_ADDRESS
FE804018 CONSTANT I2C_DEL \ I2C_DATA_DELAY_REGISTER_ADDRESS
FE80401C CONSTANT I2C_CLKT \ I2C_CLOCK_STRETCH_TIMEOUT_REGISTER_ADDRESS
...
\ EACH 3-BITS OF THE GPFSEL REPRESENTS A GPIO PIN, SO TO ADDRESS THE GPIO-2 AND GPIO-3
...
\ To slave address 0x0000003F (Because our expander model is PCF8574T)
\ Load the current value on the stack into FIFO register
\ Start the transfer
: WRITE_TO_I2C
  RESET_S
  RESET_FIFO
